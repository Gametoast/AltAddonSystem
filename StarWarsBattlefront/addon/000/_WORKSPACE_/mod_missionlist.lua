...
SPCampaign_CW = { 
 { mapluafile = "nab1c_h", side = 1, showstr = "ifs.sp.cw.map1name", description = "ifs.sp.cw.map1descr", movie = "nab1fly", voiceover = "cis_missionbriefing_nab1", intromovie = "nab1h01", outtromovie = "tutorial01cw", outtromovie_left = 50, outtromovie_top = 60, outtromovie_width = 400, outtromovie_height = 336, outtromovielocalized = 1, briefingmusic = "shell_droidinvasion", iconmodel = "com_icon_CIS"},
...
SPCampaign_GCW = { 
 { mapluafile = "tat1i_h", side = 1, showstr = "ifs.sp.gcw.map1name", description = "ifs.sp.gcw.map1descr", movie = "tat1fly", intromovie = "tat1h01", outtromovie = "tutorial01gcw", outtromovie_left = 50, outtromovie_top = 60, outtromovie_width = 400, outtromovie_height = 336, outtromovielocalized = 1, voiceover = "imp_missionbriefing_tat1", briefingmusic = "shell_imperialmarch", iconmodel = "com_icon_imperial"},
