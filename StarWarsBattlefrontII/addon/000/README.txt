...
named 'ifs_sp_better_one' then add your replacement to the 
the 'shell_overrides.lvl' file and update the 'shell_mod_overrides' table inside shell_overrides.lua 
